...
extension LegacySearchView {
    ...
    func sendLocationToServer() {
        ...
        // 🎯 新增：将开始时间存储到 UserDefaults，供后续计算时间差使用
        UserDefaults.standard.set(searchStartTime, forKey: "SearchButtonClickTime")
        ...
        SearchUtils.sendLocationToServer(
            ...
            skipDefaultEmailCheck: UserDefaults.standard.bool(forKey: "shouldSkipDefaultEmailCheck"), // 🎯 新增：传递跳过标志
            onLocationSent: {
                // 先刷新黑名单，然后开始寻找流程
