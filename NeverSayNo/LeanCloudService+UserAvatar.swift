                ...
                case .success(let records):
                    if let firstRecord = records.first,
                       let userAvatar = firstRecord["userAvatar"]?.stringValue {
                        ...
                        _ = firstRecord.objectId?.stringValue ?? "unknown"
                        _ = firstRecord.createdAt?.value.description ?? "unknown"
                        _ = firstRecord.updatedAt?.value.description ?? "unknown"
                        _ = firstRecord["userName"]?.stringValue ?? "nil"
                        _ = firstRecord["userEmail"]?.stringValue ?? "nil"
                        _ = firstRecord["deviceId"]?.stringValue ?? "nil"
