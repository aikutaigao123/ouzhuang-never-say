...
struct RecommendationItemView: View {
    ...
    @ObservedObject var locationManager: LocationManager // 🎯 新增：用于实时计算距离
    ...
    private var currentDistance: Double? {
        ...
        // ⚖️ 坐标系转换：RecommendationItem中的坐标是GCJ-02，需要转换为WGS-84才能与当前位置（WGS-84）正确计算距离
