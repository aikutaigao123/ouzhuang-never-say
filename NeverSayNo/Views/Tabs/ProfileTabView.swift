...
struct ProfileTabView: View {
    ...
    func clearAllHistory() {
        ...
        UserDefaults.standard.removeObject(forKey: "locationHistory_\(currentUser.userId)")
        UserDefaults.standard.removeObject(forKey: "blacklistedUserIds_\(currentUser.userId)")
